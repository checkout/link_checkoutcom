...
var wrapper = {
    /**
     * Initialize HTTP service for the Checkout.com sandbox for verifying Cartes Bancaires Cards
     * @returns {Object} The service instance
     */
    sandbox: function() {
        return LocalServiceRegistry.createService('cko.cartes.bancaires.sandbox.service', {
    ...
    live: function() {
        return LocalServiceRegistry.createService('cko.cartes.bancaires.live.service', {
            createRequest: function(svc, args) {
                // Prepare the http service
                svc.addHeader('Authorization', util.getAccountKeys().secretKey);
                svc.addHeader('User-Agent', util.getCartridgeMeta());
