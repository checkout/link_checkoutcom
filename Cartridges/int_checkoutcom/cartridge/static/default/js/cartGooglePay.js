...
function launchGooglePay() {
  jQuery(".cko-google-pay-button").off().click(function() {
    var e = document
        .getElementsByClassName("order-subtotal")[0]
        .innerText.split("\t")[1]
        .replace(/[^\d\.\,\s]+/g, "")
        .replaceAll(",", ""),
      t = $("#shipM").val();
    ...
    const a = { apiVersion: 2, apiVersionMinor: 0 },
      ...
      p = Object.assign({}, s, { tokenizationSpecification: o }),
      l = Object.assign({}, r, { tokenizationSpecification: o });
    let c = null;
    u()
      .isReadyToPay(Object.assign({}, a, { allowedPaymentMethods: [p, l] }))
      .then(function(e) {
        e.result &&
          (function() {
            var e = h();
    ...
    function u() {
      return (
        null === c &&
          (c = new google.payments.api.PaymentsClient({
            environment: "TEST",
            merchantInfo: {
    ...
    function g(t) {
      ...
      var i = {
        displayItems: [
          { label: "Subtotal", type: "SUBTOTAL", price: $.trim(e) },
      ...
      if (t && parseFloat(discounts[t]) > 0) {
        var o = { label: "Discounts", type: "DISCOUNT", price: n || "0.00" };
        i.displayItems.push(o);
      }
      return i;
    }
    function I(e) {
          ...
          return new Promise(function(t, a) {
            setTimeout(function() {
              ...
              if (
                ...
                var s = document.getElementById("cartUrl").value;
                $.ajax({
                  url: s,
                  data: o,
                  method: "POST",
      ...
      return new Promise(function(t, a) {
        ...
        if (
          ...
          if ("NJ" == n.administrativeArea)
            ...
            o.newShippingOptionParameters = {
              defaultSelectedOptionId: defaultShippingMethodId,
              shippingOptions: shippingMethods,
            };
            let e = o.newShippingOptionParameters.defaultSelectedOptionId;
            o.newTransactionInfo = y(e);
          }
        else
          "SHIPPING_OPTION" == e.callbackTrigger &&
            (o.newTransactionInfo = y(i.id));
        t(o);
      });
    }
    function y(e) {
    ...
    (d.transactionInfo = g()), (c = u()), c.loadPaymentData(d);
  });
}
