...
function showConfirmation(order) {
    ...
    for (var paymentInstrument = 0; paymentInstrument < paymentInstruments.length; paymentInstrument++) {
        var paymentMethod = paymentInstruments[paymentInstrument].getPaymentMethod();
        if(paymentMethod === 'CHECKOUTCOM_APPLE_PAY' && cart) {
            Transaction.wrap(function(){
                cart.calculate();
            });
        }
