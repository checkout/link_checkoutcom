...
function create() {
    ...
    try {
        ...
        var token = cardHelper.createToken({
            cardNumber: newCreditCardForm.object.number.getValue(),
            expirationMonth: newCreditCardForm.object.expiration.month.getValue(),
            expirationYear: newCreditCardForm.object.expiration.year.getValue(),
            name: newCreditCardForm.object.owner.getValue(),
