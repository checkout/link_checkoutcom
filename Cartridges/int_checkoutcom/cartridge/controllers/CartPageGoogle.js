...
function shippingMethodFetch() {
    ...
    for (i = 0; i < applicableShippingMethods.length; i++) {
        if (!applicableShippingMethods[i].custom.storePickupEnabled) {
            ...
            shipTaxes[applicableShippingMethods[i].ID] = cart.object.totalTax.value.toString();
...
exports.ShippingMethodFetch = guard.ensure(['get'], shippingMethodFetch);
exports.RedirectRoute = guard.ensure(['get'], redirectRoute);
exports.Show = guard.ensure(['post'], show);
