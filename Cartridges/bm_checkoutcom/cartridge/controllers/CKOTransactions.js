...
function remoteCall() {
    ...
    var orderNumber = request.httpParameterMap.get('orderNo'); //eslint-disable-line

    // Get the transaction currency
    var currency = request.httpParameterMap.get('currency'); //eslint-disable-line
    ...
    var formatedAmount = CKOHelper.getFormattedPrice(request.httpParameterMap.get('amount').stringValue, currency); //eslint-disable-line
    ...
    // Return the response
    CKOHelper.ckoResponse(gResponse);
}
