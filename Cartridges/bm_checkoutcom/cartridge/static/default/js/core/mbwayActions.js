...
/**
 * Wraps the default getButtonsHtml function to handle MB WAY payment method actions.
 * For MB WAY orders, Capture and Void are not supported — only Refund is available
...
(function () {
    ...
    getButtonsHtml = function (cell) { // eslint-disable-line no-global-assign
        ...
        if (rowData.payment_method !== 'CHECKOUTCOM_MBWAY') {
